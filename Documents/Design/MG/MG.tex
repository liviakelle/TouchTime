...
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] Vibration pattern to distinguish the time
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] Watch-face in which the app operates in
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] Additional functionality from watch app 
\end{description}
...
\item [\refstepcounter{mnum} \mthemnum \label{mHH}:] Output Vibration Module
\item [\refstepcounter{mnum} \mthemnum \label{mHH}:] Output Display Module
\item [\refstepcounter{mnum} \mthemnum \label{mHH}:] Control Module
\end{description}
...
\subsection{Hardware Hiding Modules (\mref{mInput})}
...
\subsubsection{Output Vibration Module (\mref{mInput})}
\begin{description}
...
\subsubsection{Output Display Module (\mref{mInput})}
\begin{description}
