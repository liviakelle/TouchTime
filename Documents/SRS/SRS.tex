...
\noindent 3. The software shall stop the touch process when the user removes their finger

\noindent 4). The software shall indicate the hour with a series of vibrations when the user touches the quadrant containing the hour hand
