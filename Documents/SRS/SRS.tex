...
% add something here, of why you chose to omit any detail, i.e. prove it
...
\vspace{2mm}
% use proper latex bulleting!
\noindent 1). the user of the product is able to physically touch (or virtually interact through a VM) an Android smart-watch
...
\noindent 3). the device in which the application operates in must be on Android Wear 2.0 or later % why this version? Are you sure you aren't... constrained?
\subsection{The Scope of the Work and the Product}
... % why this?

ELM will create the software product \textbf{TouchTime} that will allow people to tell the time by using the sense of touch alone. Our software will provide users with the vibration feedback in order to tell time, and it will be usable on Android Wear 2.0 and Android OS 7.1.1 (or later) devices. % already stated
...
\noindent 2). The software shall enter TouchTime mode when the user touches the face

\noindent 3. The software shall stop the touch process when the user removes their finger % what is the touch process?

\noindent 4). The software shall indicate the hour with a series of vibrations when the user touches the quadrant containing the hour hand % how many times? be specific

\noindent 5). The software shall indicate the hour with a series of vibrations when the user touches the 10-minute section containing the minute hand.
...
The user should be capable of opening an application on an Android smart-watch and should be able to touch a screen. % not a requirement of the system, maybe assumption?
...
The application shall not exceed the load for the Android smart-watch % android is open source, how can you be sure?

\subsection{Operational and Environmental Requirements}

\subsubsection{Expected Physical Environment}

The application shall be used on an Android smart-watch that is at least version 8. % not physical

\subsection{Maintainability and Support Requirements}

The application shall be maintained with every Android OS update to ensure compatibility % elapsed time between dev OS release and app release?
...
% reformat this to paragraph form
...
Training for android development and Android studio environment in general can be found \href{https://developer.android.com/index.html}{here} % this is for the user, not dev team
